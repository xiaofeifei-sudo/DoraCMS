          ...
          <el-col :span="17">
            <el-row :gutter="15">
                  ...
                  <el-card class="box-card">
                    ...
                    <el-form-item label="切换编辑器">
                      <el-button
                        ...
                        size="small"
                        type="primary"
                        ><span v-if="editType">MarkDown</span
                        ><span v-else>富文本</span></el-button
                      >
                    </el-form-item>
                  </el-card>
                </div>
              ...
              <el-col :span="24" style="margin-top: 15px">
                <div v-if="editType" class="grid-content bg-purple">
                  <vue-ueditor-wrap
                    class="editorForm"
                    @ready="editorReady"
                ...
                <div v-else>
                  <mavon-editor
                    @change="mavonEditorChange"
                    :value="
                      JSON.parse(formState.formData.simpleComments)[0].content
                    "
                    ref="md"
                    :ishljs="true"
      ...
      this.$refs[formName].validate(async (valid) => {
        if (valid) {
          try {
            let params;
            if (this.editType) {
              params = Object.assign({}, this.formState.formData, {
